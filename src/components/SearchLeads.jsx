...
export default function SearchLeads() {
  ...
  const matchedLeads = leads.filter(
    (lead) =>
      lead.company &&
      lead.company.toLowerCase() === client.toLowerCase()
  );
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="border-4 border-gray-200  rounded-lg min-h-96 p-4">
            ...
            <div className="flex mb-4 gap-2">
              ...
              />
              <button
                onClick={() => handleAddClient(newClientName)}
            ...
            <div className="flex flex-col rounded-lg p-3 bg-white space-y-3 mb-4">
              ...
              {clients.map((client, index) => (
                <p
                  ...
                  className={`px-2 py-1 rounded-md w-fit cursor-pointer transition duration-200 hover:-translate-y-1 ${selectedClient === client
